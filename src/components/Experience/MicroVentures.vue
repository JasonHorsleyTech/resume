<template>
    <div>
        ...
        <p>
            I am currently employed as a full stack developer, working on any and all company code. The MicroVentures
            codebase consists of a client facing investment platform, an in house management console, a native IOS app,
            an electron based 'secure document storage' desktop application, a covid relief charity site, a zendesk help
            center and a wordpress marketing site.
        </p>
        <p>
