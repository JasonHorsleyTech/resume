<template>
    <div>
        ...
        <p>
            ...
            "interactive books" via our javascript engine. The books exported to a content management system, written as
            a custom PHP LAMP stack. That in house management tool was used to structure, map, and bundle each
            "interactive book" into cordova wrapped android applications.
        </p>
